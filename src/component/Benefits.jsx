...
const benefits = [
    ...
    },
    {
        title: '100% Natural',
        description:
            'Free from chemicals, preservatives, and artificial fragrances, ensuring pure nourishment.',
    },
    {
    ...
    //     description:
    //         'Upholding Ghana’s longstanding shea butter heritage, combining craftsmanship with organic standards.',
    // },
    // {
    //     title: 'Empowerment & Fairness',
    //     description:
    //         'Most Ghana shea brands work closely with local women’s cooperatives, ensuring fair trade and sustainable livelihoods.',
    // },
];
...
export default function Benefits() {
    return (
        <section
            id="benefits"
            className="bg-gradient-to-b from-green-50 to-amber-200 py-20 scroll-mt-20"
        >
            <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                <div className="flex flex-col gap-10 justify-center">
                    <div>
                        <h1 className="text-green-600 font-semibold text-lg">Why Choose Us</h1>
                        <h2 className="text-4xl md:text-5xl font-bold text-[#0A2540] mt-2 leading-snug">
                            Nature&apos;s Gift to{' '}
                            <span className="text-amber-600 block">Your Skin</span>
                        </h2>
                        <p className="text-base text-gray-600 mt-4 max-w-md">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        {benefits.map((benefit, index) => (
                            ...
                            >
                                <h4 className="font-semibold text-[#0A2540] text-base">
                                    {benefit.title}
                                </h4>
                ...
                <div className="flex justify-center">
                    <img
                        ...
                        className="w-full max-h-[750px] object-cover rounded-xl shadow-xl hover:shadow-2xl transition duration-500"
                    />
                </div>
            </div>
        </section>
