            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mt-2 mb-6">
                        Nature's Gift to <span className="text-amber-600 block">Your Skin</span>
                    </h2>
                ...
                <div className="grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3">
                    {benefits.map((benefit, index) => (
                        <div
                            key={index}
                            className="group bg-white p-8 shadow-md hover:shadow-amber-200 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"
                        >
                            <div className="bg-gray-50 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:ring-2 group-hover:ring-amber-400 transition duration-300">
                                {benefit.icon}
                            </div>
